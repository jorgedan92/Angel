...
async function removeMessage(message) {
    ...
    if (message.message_id) {
        bot.sendMessage(
            chatId,
            `Mensagem apagada com sucesso do banco de dados, <b><a href="tg://user?id=${user.id}">${user.first_name}</a></b>. Obrigada por manter tudo em ordem! As respostas ligadas a essa mensagem também foram removidas. Se precisar de mais alguma coisa, é só me chamar, tá bom? 🕊️✨`,
